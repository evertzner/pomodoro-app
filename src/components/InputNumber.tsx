...
const InputNumber = () => {
  ...
  return (
    <div className='relative'>
      <input
        type='number'
        className='appearance-none outline-none text-sm font-bold text-blue-900 bg-blue-50 grid grid-cols-[1fr_max-content] w-[140px] items-center rounded-[10px] overflow-hidden p-4'
        value={inputValue}
